 ...
 |                     Date:  2-Jul-25 21:04:30 (PID=13912)                     |
 |                    +-----------------------------------+                     |
 |                    |               Test4               |                     |
 |                    +-----------------------------------+                     |
 ...
 *W* 115/1230 Wrong checksum for global PERMAS format file 'C:\Program
 ...
 8850                 $ELPROP
 8853              $END SYSTEM
 8855              $CONSTRAINTS  NAME = C_STEP_1
 8857                 $SUPPRESS  DOFS = 1,2,3  DOFTYPE = DISP
 8860              $END CONSTRAINTS
 8862              $LOADING  NAME = L_STEP_1
 8864                 $DISLOAD PRESS  LPAT = 1  IDS = ELGEO  NODES = ALL  DOFTYPE = DISP
 8882              $END LOADING
 8884           $EXIT COMPONENT
 8886           $ENTER MATERIAL
 8888              $MATERIAL  NAME = GJS  TYPE = ISO
 8890                 $ELASTIC  GENERAL  INPUT = DATA
 8893                 $DENSITY  GENERAL  INPUT = DATA
 8896              $END MATERIAL
 8898           $EXIT MATERIAL
 8900           $FIN
 <<<<<< Returning from 'Test4.dat'
 ...
 *C* 320/0023 Situation STEP_1 activated in component DFLT_COMP
 ...
 Sum of applied loads (Ref.Point: 0.00E+00/ 0.00E+00/ 0.00E+00) in situation STEP_1 of component DFLT_COMP
 =========================================================================================================
  
 > Summary for all nodes in component system (Table SUMLOAD.DISP)
 ---------------------------------------------------------------------------------------------
   Pattern-ID        Fu           Fv           Fw         Mphiu        Mphiv        Mphiw
 ---------------------------------------------------------------------------------------------
              1 -3.33379E-05 -7.00000E+02  6.12483E-06  7.00000E+01 -4.97349E-06  1.27510E-05
 ---------------------------------------------------------------------------------------------
  
  
  
 Sum of reaction forces (Ref.Point: 0.00E+00/ 0.00E+00/ 0.00E+00) in situation STEP_1 of component DFLT_COMP
 ===========================================================================================================
  
 > Summary for all nodes in component system (Table SUMREAK.DISP)
 ---------------------------------------------------------------------------------------------
   Pattern-ID        Fu           Fv           Fw         Mphiu        Mphiv        Mphiw
 ---------------------------------------------------------------------------------------------
              1  3.33377E-05  7.00000E+02 -6.12476E-06 -7.00000E+01  4.97346E-06 -1.27512E-05
 ---------------------------------------------------------------------------------------------
  
  
  
 Residuum of LOAD-REAK summaries in situation STEP_1 of component DFLT_COMP
 ==========================================================================
  
 > Summary for all nodes in component system (Table ?RESI.DISP)
 ---------------------------------------------------------------------------------------------
   Pattern-ID        Fu           Fv           Fw         Mphiu        Mphiv        Mphiw
 ---------------------------------------------------------------------------------------------
              1 -2.40107E-10  0.00000E+00  7.54881E-11  0.00000E+00 -2.68301E-11 -1.21872E-10
 ---------------------------------------------------------------------------------------------
  
  
         PERMAS run ended without errors (1 Comments)
         There are 1 Warning Messages, please check
         -------------------------------------------------------------------
